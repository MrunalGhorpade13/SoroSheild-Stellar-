...
export const UserGuide: React.FC = () => {
  return (
    <div className="bg-white rounded-2xl border border-slate-100 p-6 shadow-sm space-y-8 max-w-4xl mx-auto animate-fade-in">
      {/* Introduction */}
      <div className="border-b border-slate-100 pb-5">
        <div className="flex items-center gap-2 mb-2">
          <BookOpen className="w-5 h-5 text-stellar-blue" />
